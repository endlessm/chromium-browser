...
class JSONParser {
 public:
  ...
  Optional<Value> Parse(std::experimental::string_view input);
 ...
 private:
  ...
  Optional<std::experimental::string_view> PeekChars(int count);
  ...
  Optional<std::experimental::string_view> ConsumeChars(int count);
